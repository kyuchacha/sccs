		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				...
				(function(container){
					...
					output_2.value = "인풋 박스와 검색 버튼이 결합된 컨트롤입니다.\r\n\r\n데이터를 입력할 수 있는 컨트롤입니다.\r\n데이터 입력, 출력, 수정이 가능합니다.";
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "서치 인풋 컨트롤에 값이 들어있지 않을 때 출력되는 문구를 설정하는 속성입니다.";
						...
						(function(container){
							...
							output_18.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 서치 인풋 컨트롤에서 해당 속성의 기능을 확인할 수 있습니다.";
							output_18.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_21.value = "서치 인풋의 ClearButton을 보이지 않게 설정하는 속성입니다. 기본값은 false이며, true로 변경 시 ClearButton이 보이지 않게 됩니다.";
						...
						(function(container){
							...
							output_26.value = "ClearButton의 숨김여부를 반환합니다.";
							output_26.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_27.value = "ClearButton의 숨김여부를 설정합니다.";
							output_27.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_31.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 서치 인풋 컨트롤에서 해당 속성의 기능을 확인할 수 있습니다. ";
					...
					(function(container){
						...
						(function(container){
							...
							output_34.value = "서치 인풋의 검색 버튼을 보이지 않게 설정하는 속성입니다. 기본값은 false이며, true로 변경 시 검색 버튼이 보이지 않게 됩니다.";
						...
						(function(container){
							...
							output_39.value = "검색 버튼의 숨김여부를 반환합니다.";
							output_39.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_40.value = "검색 버튼의 숨김여부를 설정합니다.";
							output_40.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_44.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 서치 인풋 컨트롤에서 해당 속성의 기능을 확인할 수 있습니다. ";
					...
					(function(container){
						...
						(function(container){
							...
							output_47.value = "검색 버튼의 위치를 설정하는 속성입니다. 기본값은 right이며, left로 변경 시 검색 버튼이 텍스트 왼쪽에 표시됩니다.";
						...
						(function(container){
							...
							output_57.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 서치 인풋 컨트롤에서 해당 속성의 기능을 확인할 수 있습니다. ";
					...
					(function(container){
						...
						(function(container){
							...
							output_60.value = "서치 인풋의 버튼 포커스 여부를 설정하는 속성입니다. 기본값은 false이며, true로 변경 시 버튼에 포커스가 갈 수 있습니다.";
						...
						(function(container){
							...
							output_70.value = "1) 서치 인풋을 클릭합니다.\r\n2) Tab 키를 누릅니다.\r\n3) x 버튼으로 포커스가 이동합니다.\r\n4) Tab 키를 누릅니다.\r\n5) 검색 버튼으로 포커스가 이동합니다.";
