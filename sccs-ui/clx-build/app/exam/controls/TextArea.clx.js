				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "컨트롤에 값이 들어있지 않을 때 출력되는 문구를 설정하는 속성입니다.";
						...
						(function(container){
							...
							output_18.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 컨트롤에서 해당 속성의 기능을 확인할 수 있습니다.";
							output_18.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_21.value = "컨트롤에 최대 입력할 수 있는 길이를 설정하는 속성입니다. lengthUnit에 따라 값이 달라질 수 있습니다.";
						...
						(function(container){
							...
							output_31.value = "1) 입력값을 선택하고 실행 버튼을 클릭합니다.\r\n2) 하단의 텍스트 에리어에 선택 값 이상의 텍스트가 입력되지 않는 것을 확인할 수 있습니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_34.value = "입력한 문자열의 길이가 maxLength에 도달했을 경우 다음 컨트롤로 포커스 이동 여부를 설정하는 속성입니다. 기본값은 false이며, true로 변경 시 다음 컨트롤로 포커스 이동이 가능해집니다.";
						...
						(function(container){
							...
							output_45.value = "1) 우측의 입력값 속성에 따른 텍스트 에리어의 기능을 하단에서 확인할 수 있습니다.\r\n2) 텍스트 에리어에 5자 이상 텍스트를 입력합니다.\r\n3) 포커스가 다음으로 넘어가는 것을 확인합니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_48.value = "텍스트 에리어 컨트롤에 포커스 될 때 편집 영역의 데이터를 전체 선택할 수 있게 설정하는 속성입니다. 기본값은 false이며, true로 변경 시 포커스 될 때 전체 값이 선택됩니다.";
						...
						(function(container){
							...
							output_58.value = "1) 입력값을 선택하고 실행 버튼을 클릭합니다.\r\n2) 하단의 텍스트 에리어를 클릭하여 속성에 따른 기능 변경을 확인할 수 있습니다.";
