				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_13.value = "아이템의 넓이를 고정할지를 여부를 반환합니다. ";
							output_13.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_14.value = "아이템의 넓이를 고정할지 여부를 설정합니다.";
							output_14.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_18.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 라디오 버튼 컨트롤에서 해당 속성의 기능을 확인할 수 있습니다. ";
					...
					(function(container){
						...
						(function(container){
							...
							output_21.value = "라디오 버튼에서 한 줄에 표시되는 아이템의 숫자를 설정하는 속성입니다.";
						...
						(function(container){
							...
							output_31.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 라디오 버튼 컨트롤에서 해당 속성의 기능을 확인할 수 있습니다.";
							output_31.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_34.value = "라디오 버튼 아이콘의 위치를 정하는 속성입니다. 기본값은 left이며 right, top, bottom으로 변경할 수 있습니다.";
						...
						(function(container){
							...
							output_44.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 라디오 버튼 컨트롤 아이콘의 위치가 변경된 것을 확인할 수 있습니다.";
							output_44.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_47.value = "아이템의 텍스트 표현 형식을 표현식의 형태로 정의하는 속성입니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_75.value = "표현식을 통해 아이템을 필터링하는 속성입니다.";
						...
						(function(container){
							...
							output_80.value = "아이템 목록의 필터 조건을 반환합니다. ";
							output_80.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_81.value = "아이템 목록의 필터 조건을 설정합니다. ";
							output_81.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
