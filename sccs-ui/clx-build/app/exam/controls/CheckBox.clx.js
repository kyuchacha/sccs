		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				...
				(function(container){
					...
					output_2.value = "체크되거나 체크되지 않은 상태를 선택하는 컨트롤입니다.\r\n체크 상태를 토글 할 수 있습니다. 체크된 상태와 체크되지 않은 상태의 값을 별도로 지정할 수 있습니다.";
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_13.value = "checkbox의 텍스트를 반환합니다.";
							output_13.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_14.value = "checkbox의 텍스트를 설정합니다.";
							output_14.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_18.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 체크 박스 내부의 텍스트가 변경되는 것을 확인할 수 있습니다.";
							output_18.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_21.value = "체크박스 아이콘의 위치를 설정하는 속성입니다. 기본값은 left이며 right, bottom, top으로 변경이 가능합니다.";
							output_21.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_26.value = "아이콘 정렬 위치를 반환합니다.";
							output_26.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_27.value = "아이콘 정렬 위치를 설정합니다.";
							output_27.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_31.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 체크 박스 아이콘의 위치가 변경된 것을 확인할 수 있습니다.";
							output_31.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_34.value = "체크 박스 컨트롤의 value를 통해 체크 박스의 체크 상태를 컨트롤할 수 있습니다.";
							output_34.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_44.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 체크 박스 컨트롤 체크 상태가 변경된 것을 확인할 수 있습니다.";
							output_44.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_47.value = "컨트롤의 수정 가능 여부를 설정하는 속성입니다. 기본값은 false이며, true로 변경 시 컨트롤을 수정할 수 없습니다.";
							output_47.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_57.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 체크 박스 컨트롤의 읽기 전용 모드가 설정되는 것을 확인할 수 있습니다.";
							output_57.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_60.value = "체크 박스의 활성화 여부를 결정하는 속성입니다. 기본값은 true이며, false로 변경 시 체크박스가 클릭되지 않습니다.";
							output_60.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_70.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 체크 박스 컨트롤에서 해당 속성의 기능을 확인할 수 있습니다. ";
							output_70.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_73.value = "체크박스 아이템의 넓이를 고정하는 속성입니다. 기본값은 false이며, true로 변경 시 넓이가 고정됩니다.\r\ncheckbox.part.less에서 말줄임표 스타일을 적용하기 위해서는 fixedWidth = true로 설정해야 합니다.";
							output_73.style.css({
								"font-weight" : "700"
							});
						...
						(function(container){
							...
							output_78.value = "아이템의 넓이를 고정할지를 여부를 반환합니다.";
							output_78.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_79.value = "아이템의 넓이를 고정할지를 여부를 설정합니다.";
							output_79.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_83.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 체크 박스 컨트롤에서 해당 속성의 기능을 확인할 수 있습니다. ";
							output_83.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							(function(container){
								...
								checkBox_7.value = "";
								checkBox_7.text = "CheckBoxCheckBox";
