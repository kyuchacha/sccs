		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				...
				(function(container){
					...
					output_2.value = "외부의 웹페이지를 앱에 포함하여 보여주는 컨트롤입니다.\r\n\r\niframe을 사용하여 대부분의 페이지를 출력할 수 있습니다. sandbox 속성을 이용하여 iframe의 제한을 설정할 수 있으며, 브라우저에서 iframe을 지원하지 않는 경우 출력하는 메시지 속성을 제공합니다.";
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "임베디드 페이지 iframe의 name 속성을 설정하는 속성입니다. ";
							output_8.style.css({
								"font-weight" : "700"
							});
					...
					(function(container){
						...
						(function(container){
							...
							output_22.value = "임베디드 페이지 내에서 스크롤을 생성하는 속성입니다. 기본값은 auto이며 yes, no를 수동으로 지정할 수 있습니다.\r\n- yes : 스크롤을 항상 설정합니다.\r\n- no : 스크롤을 설정하지 않습니다.\r\n- auto : 스크롤이 필요할 시 설정됩니다.";
							output_22.style.css({
								"font-weight" : "700"
							});
