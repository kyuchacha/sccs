/*
 * App URI: app/exam/controls/ctrlPrev/EmbeddedAppPrev
 * Source Location: app/exam/controls/ctrlPrev/EmbeddedAppPrev.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/controls/ctrlPrev/EmbeddedAppPrev", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				...
				output_1.value = "임베디드앱(EmbeddedApp)은 앱 안에 앱을 넣을 수 있도록 도와주는 컨트롤입니다.";
				...
				(function(container){
					...
					embeddedApp_1.enabled = false;
					cpr.core.App.load("app/exam/controls/ctrlPrev/ctrlPrev/Accordion2", function(app) {
						if(app){
					...
					output_2.value = "[enabled = false]\r\n1. 임베디드 앱을 클릭되지 않는다.";
					container.addChild(output_2, {
						"colIndex": 0,
						"rowIndex": 0
					});
					var embeddedApp_2 = new cpr.controls.EmbeddedApp("embapp2");
					embeddedApp_2.readOnly = true;
					cpr.core.App.load("app/exam/controls/ctrlPrev/FileInput", function(app) {
						if(app){
