				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							output_8.value = "인풋 박스에 값이 들어있지 않을 때 출력되는 문구를 설정하는 속성입니다.";
						...
						(function(container){
							...
							output_18.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 인풋 박스 컨트롤에서 해당 속성의 기능을 확인할 수 있습니다. ";
							output_18.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_21.value = "인풋 박스에 password 설정을 할 수 있는 속성입니다. 기본값은 false이며, true로 변경 시 값이 마스킹 되어 처리되게 됩니다.";
						...
						(function(container){
							...
							output_31.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 인풋 박스 컨트롤에서 해당 속성의 기능을 확인할 수 있습니다.";
							output_31.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
					...
					(function(container){
						...
						(function(container){
							...
							output_34.value = "인풋 박스에 최대 입력할 수 있는 길이를 설정하는 속성입니다. lengthUnit에 따라 값이 달라질 수 있습니다.";
						...
						(function(container){
							...
							output_44.value = "1) 입력값을 선택하고 실행 버튼을 클릭합니다.\r\n2) 하단의 인풋 박스에 선택 값 이상의 텍스트가 입력되지 않는 것을 확인할 수 있습니다.";
					...
					(function(container){
						...
						(function(container){
							...
							output_47.value = "인풋 박스에 정규 표현식을 통해 입력값을 제한할 수 있는 속성입니다.";
						...
						(function(container){
							...
							output_57.value = "입력값을 선택하고 실행 버튼을 누르면 하단의 인풋 박스 컨트롤에서 해당 속성의 기능을 확인할 수 있습니다.\r\n- ^[0-9\\-]*$ : 숫자와 하이픈만 입력할 수 있습니다.\r\n- ^[0-9]*$ : 숫자만 입력할 수 있습니다.\r\n- ^[a-zA-Z]*$ : 영어 대문자와 소문자만 입력할 수 있습니다.";
					...
					(function(container){
						...
						output_59.value = "showClearButton";
						output_59.style.css({
							"color" : "#2263b3",
							"font-weight" : "700",
							"font-size" : "20px",
						...
						(function(container){
							...
							output_60.value = "ClearButton의 표시 여부를 설정하는 속성입니다. 기본값은 false이며, true로 변경 시 ClearButton이 표시됩니다.\r\nClearButton을 클릭하면 인풋 박스에 입력된 값이 지워집니다.";
						...
						(function(container){
							...
							output_65.value = "clear버튼의 표시여부를 반환합니다.";
							output_65.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
							...
							output_66.value = "clear버튼의 표시여부를 설정합니다.";
							output_66.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							output_70.value = "입력값을 선택하고 실행 버튼을 누르면, 하단의 인풋 박스 컨트롤에서 해당 속성의 기능을 확인할 수 있습니다. ";
							output_70.style.css({
								"background-color" : "transparent",
								"border-right-style" : "none",
								"border-left-style" : "none",
						...
						(function(container){
							...
							(function(container){
								...
								var inputBox_6 = new cpr.controls.InputBox("sampleControl5");
								inputBox_6.value = "tomato";
