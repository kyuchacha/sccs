/*
 * App URI: app/exam/appSmpl/faq&qna/expEginSmpl
 * Source Location: app/exam/appSmpl/faq&qna/expEginSmpl.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/appSmpl/faq&qna/expEginSmpl", {
			...
			(function(container){
				...
				(function(container){
					...
					(function(container){
						...
						output_1.value = "익스프레션 엔진을 사용해 표현식 등록하는 방법";
						output_1.style.css({
							"font-weight" : "bold",
							"padding-left" : "1rem",
							"font-size" : "2.5rem"
				...
				formLayout_2.setColumns(["1fr", "470px"]);
				...
				(function(container){
					...
					(function(container){
						...
						(function(container){
							...
							formLayout_5.setColumns(["24px", "200px", "1fr", "170px", "120px"]);
							...
							(function(container){
								...
								inputBox_2.value = "registerFunction()";
								...
								inputBox_3.value = "입력값을 결과창에 출력하는 사용자 정의 함수를 등록하고 바인딩합니다.";
				...
				(function(container){
					...
					(function(container){
						...
						if(typeof onSelNumValueChange == "function") {
							output_19.addEventListener("value-change", onSelNumValueChange);
						}
