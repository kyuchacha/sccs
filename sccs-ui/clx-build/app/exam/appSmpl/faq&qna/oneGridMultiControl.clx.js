/*
 * App URI: app/exam/appSmpl/faq&qna/oneGridMultiControl
 * Source Location: app/exam/appSmpl/faq&qna/oneGridMultiControl.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/appSmpl/faq&qna/oneGridMultiControl", {
			...
			* oneGridMultiControl.js
			...
			(function(container){
				...
				(function(container){
					...
					output_4.value = "1. controlNm 컬럼의 콤보박스 컨트롤에서 값을 변경해가며 value 컬럼의 컨트롤이 변경되는지 확인합니다.";
				...
				(function(container){
					...
					(function(container){
						...
						output_8.bind("value").toExpression("#selOpt.value + ' ' + #selNum.value");
						container.addChild(output_8, {
							"width": "100px",
							"height": "25px"
						});
						var output_9 = new cpr.controls.Output("selOpt");
						...
						var output_10 = new cpr.controls.Output("selNum");
						output_10.visible = false;
						output_10.value = "11611";
						output_10.style.css({
							"color" : "#FF9149"
						});
						...
						output_11.value = "우측하단 '이동' 버튼을 통해 관련글을 조회할 수 있습니다.";
						output_11.style.css({
							"color" : "#FF9149"
						});
						...
						(function(container){
							...
							if(typeof onMoveButtonClick == "function") {
								button_1.addEventListener("click", onMoveButtonClick);
							}
						...
						if(typeof onGrp7Click == "function") {
							group_13.addEventListener("click", onGrp7Click);
						}
