/*
 * App URI: app/exam/appSmpl/faq&qna/gridAddedEdit
 * Source Location: app/exam/appSmpl/faq&qna/gridAddedEdit.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/appSmpl/faq&qna/gridAddedEdit", {
			...
			(function(container){
				...
				(function(container){
					...
					(function(container){
						...
						output_1.value = "그리드 신규 행만 편집가능하도록 하는 방법";
						output_1.style.css({
							"font-weight" : "bold",
							"padding-left" : "1rem",
							"font-size" : "2.5rem"
					...
					output_2.value = "이 문서는 그리드 신규 행만 편집가능하도록 하는 방법에 대해서 설명합니다.";
				...
				(function(container){
					...
					output_4.value = "1. 그리드에 값들을 수정해봅니다.\r\n2. 수정되지않습니다.\r\n3. 버튼을 눌러 신규행을 만듭니다.\r\n4. 신규행은 수정이 가능합니다.";
					...
					(function(container){
						...
						output_6.value = "아래 예제에서는 스크립트를 통해 표현식이 적용되어 있지만 그리드 편집창에서 직접 컨트롤들에 익스프레션 바인딩을 해도 동일하게 동작합니다.";
						output_6.style.css({
							"color" : "#09c2de"
						});
											...
											},
											{
												...
												"configurator": function(cell){
													...
													cell.control = (function(){
														...
														inputBox_1.bind("value").toDataColumn("empId");
														return inputBox_1;
													})();
											...
											},
											{
												...
												"configurator": function(cell){
													...
													cell.control = (function(){
														...
														inputBox_2.bind("value").toDataColumn("empNm");
														return inputBox_2;
													})();
													cell.controlConstraint = {};
												}
											...
											},
											{
												...
												"configurator": function(cell){
													...
													cell.control = (function(){
														...
														inputBox_5.bind("value").toDataColumn("address");
														return inputBox_5;
													})();
													cell.controlConstraint = {};
												}
											},
											{
												...
												"configurator": function(cell){
													...
													cell.control = (function(){
														...
														inputBox_6.bind("value").toDataColumn("rgstDt");
														return inputBox_6;
													})();
													cell.controlConstraint = {};
												}
