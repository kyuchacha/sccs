/*
 * App URI: app/exam/appSmpl/faq&qna/queryString
 * Source Location: app/exam/appSmpl/faq&qna/queryString.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/appSmpl/faq&qna/queryString", {
			...
			(function(container){
				...
				(function(container){
					...
					(function(container){
						...
						output_1.value = "QueryString을 반환받는 방법";
						output_1.style.css({
							"font-weight" : "bold",
							"padding-left" : "1rem",
							"font-size" : "2.5rem"
					...
					output_2.value = "이 문서는 QueryString을 반환받는 방법에 대해서 설명합니다.";
				...
				(function(container){
					...
					output_4.value = "1. 입력값에 값을 입력합니다.\r\n2. 첫번째 실행 버튼 클릭 시, 입력한 값이 현재 페이지 url에 질의문자열로 삽입됩니다. (질의문자열에 key는 name이란 문자열로 들어갑니다.)\r\nex) ?name=입력값\r\n3. 두번째 실행 버튼 클릭 시, searchParams.get API를 이용해 삽입된 질의문자열을 결과값 아웃풋에 출력합니다.";
				...
				(function(container){
					...
					(function(container){
						...
						var group_9 = new cpr.controls.Container("grp19");
						// Layout
						...
						(function(container){
							var group_10 = new cpr.controls.Container("grpFormFunc");
							...
							(function(container){
								...
								formLayout_6.setColumns(["24px", "200px", "1fr", "170px", "120px"]);
								...
								(function(container){
									...
									inputBox_2.value = "history.pushState()";
									...
									inputBox_3.value = "url에 질의문자열을 추가합니다.";
								...
								(function(container){
									...
									inputBox_4.value = "url로부터 질의문자열을 받아옵니다.";
									...
									inputBox_5.value = "searchParams.get()";
				...
				(function(container){
					...
					(function(container){
						...
						output_16.value = "1.0.2544 릴리즈 버전";
						output_16.style.css({
							"color" : "#FF9149",
							"font-weight" : "bolder"
						});
						...
						output_17.value = "다음의 속성들이 읽기/쓰기가 가능하도록 개선되었습니다:\r\nhref\r\nprotocol\r\nusername\r\npassword\r\nhost\r\nhostname\r\nport\r\npathname\r\nhash\r\nsearch\r\n\r\nsearchParams 속성이 추가되어 이를 통해 서치 파라미터들을 수정할 수 있습니다. 이는 표준 URLSearchParams을 따릅니다.";
						output_17.style.css({
							"color" : "#FF9149"
						});
				...
				group_17.style.setClasses(["card-inner"]);
				// Layout
