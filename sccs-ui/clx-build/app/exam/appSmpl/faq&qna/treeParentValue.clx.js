/*
 * App URI: app/exam/appSmpl/faq&qna/treeParentValue
 * Source Location: app/exam/appSmpl/faq&qna/treeParentValue.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/appSmpl/faq&qna/treeParentValue", {
			...
			(function(container){
				...
				(function(container){
					...
					(function(container){
						...
						output_1.value = "트리 최상위 부모의 value 가져오기";
						output_1.style.css({
							"font-weight" : "bold",
							"padding-left" : "1rem",
							"font-size" : "2.5rem"
					...
					output_2.value = "이 문서는 트리 컨트롤의 최상위 부모의 value를 가져오는 방법에 대해서 설명합니다.\r\n트리에서 제공하는 API를 사용하여 트리 아이템의 부모 아이템을 찾아 확인 할 수 있습니다.";
				...
				(function(container){
					...
					output_4.value = "1. getItemValue API를 통해 선택된 아이템의 초상위 부모 아이템을 확인합니다.";
					...
					(function(container){
						...
						(function(container){
							...
							(function(container){
								...
								var tree_1 = new cpr.controls.Tree("treMn");
								tree_1.autoOpen = -1;
								(function(tree_1){
									tree_1.setItemSet(app.lookup("dsList"), {
										"label": "label",
										"value": "value",
										"parentValue": "parent"
									});
					...
					(function(container){
						...
						(function(container){
							...
							(function(container){
								...
								inputBox_1.value = "getItemByValue()";
								...
								inputBox_2.value = "value에 해당되는 아이템을 가져올 수 있습니다.";
								container.addChild(inputBox_2, {
									"colIndex": 2,
									"rowIndex": 1
								});
								var comboBox_1 = new cpr.controls.ComboBox("cmb2");
								comboBox_1.placeholder = "타겟 아이템 선택";
								(function(comboBox_1){
				...
				(function(container){
					...
					(function(container){
						...
						if(typeof onSelNumValueChange == "function") {
							output_18.addEventListener("value-change", onSelNumValueChange);
						}
