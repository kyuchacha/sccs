/*
 * App URI: app/exam/validation2/oneGridValidation
 * Source Location: app/exam/validation2/oneGridValidation.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/validation2/oneGridValidation", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			// Header
			app.declareAppProperty("useLayerdPop", "Y");
			...
			if(typeof onDsEmpUpdate == "function") {
				dataSet_2.addEventListener("update", onDsEmpUpdate);
			}
			if(typeof onDsEmpClear == "function") {
				dataSet_2.addEventListener("clear", onDsEmpClear);
			}
			...
			(function(container){
				...
				(function(container){
							...
							"cells": [
								...
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											var userDefinedControl_3 = new udc.com.gridTextArea();
											userDefinedControl_3.bind("columnName").toDataColumn("ADDRESS");
								...
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											...
											inputBox_7.bind("value").toDataColumn("PWD");
											return inputBox_7;
										})();
										cell.controlConstraint = {};
									}
								},
								{
									...
									"configurator": function(cell){
										...
										cell.control = (function(){
											...
											inputBox_8.bind("value").toDataColumn("LOGINID");
											return inputBox_8;
										})();
										cell.controlConstraint = {};
									}
					...
					formLayout_5.setColumns(["1fr", "80px", "260px"]);
					...
					(function(container){
						...
						userDefinedControl_5.focusColumnName = "EMPNO";
						...
						(function(comboBox_5){
							comboBox_5.addItem(new cpr.controls.Item("2줄", "2"));
							comboBox_5.addItem(new cpr.controls.Item("3줄", "3"));
							comboBox_5.addItem(new cpr.controls.Item("4줄", "4"));
							comboBox_5.addItem(new cpr.controls.Item("5줄", "5"));
							comboBox_5.addItem(new cpr.controls.Item("원복", ""));
						})(comboBox_5);
						if(typeof onCmb2SelectionChange == "function") {
							comboBox_5.addEventListener("selection-change", onCmb2SelectionChange);
						}
