/*
 * App URI: app/exam/guide/util/UtilSample01
 * Source Location: app/exam/guide/util/UtilSample01.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/guide/util/UtilSample01", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				...
				(function(container){
					...
					output_3.value = "이 페이지에서는 Value 체크 및 형 변환 기능을 수행하는 ValueUtil 공통모듈에 대해 설명합니다.";
				...
				(function(container){
					...
					output_5.value = "1. 동작버튼을 클릭한다. (필요시 입력값 입력)\r\n2. 기능 동작 및 결과값을 확인한다.\r\n3. 스크립트를 확인한다.\r\n4. 스크립트를 복사하여 코딩에 활용한다.";
					...
					(function(container){
						...
						(function(container){
							...
							(function(container){
								...
								formLayout_7.setColumns(["24px", "150px", "1fr", "180px", "140px"]);
								formLayout_7.setRows(["25px", "25px", "25px", "25px", "25px", "25px", "25px", "25px", "25px", "25px", "25px"]);
								...
								(function(container){
									...
									inputBox_2.value = "해당 값이 Null인지 여부를 체크하여 반환";
									...
									inputBox_3.value = "해당 값이 숫자인지 여부를 체크하여 반환";
									...
									inputBox_12.value = "해당 값에 대한 문자열 반환";
									...
									inputBox_13.value = "해당 값을 Boolean 타입으로 변환";
									...
									inputBox_14.value = "해당 값을 숫자 타입으로 변환";
									...
									inputBox_15.value = "해당 값을 Float 타입으로 변환";
									...
									inputBox_16.value = "문자열을 split한 배열 반환";
									...
									inputBox_17.value = "해당 값의 앞/뒤 공백을 제거한 문자열 반환";
									...
									var inputBox_19 = new cpr.controls.InputBox("ipbIsNull");
									inputBox_19.value = "입력값이 있으면 false";
									container.addChild(inputBox_19, {
										"colIndex": 3,
										"rowIndex": 1
									});
									var inputBox_20 = new cpr.controls.InputBox("ipbIsNum");
									inputBox_20.value = "12345";
									container.addChild(inputBox_20, {
										"colIndex": 3,
										"rowIndex": 2
									});
									var inputBox_21 = new cpr.controls.InputBox("ipbFixNull");
									inputBox_21.value = "abcd123";
									container.addChild(inputBox_21, {
										"colIndex": 3,
										"rowIndex": 3
									});
									var inputBox_22 = new cpr.controls.InputBox("ipbFixBoolean");
									inputBox_22.value = "";
									container.addChild(inputBox_22, {
										"colIndex": 3,
										"rowIndex": 4
									});
									var inputBox_23 = new cpr.controls.InputBox("ipbFixNum");
									inputBox_23.value = "0123";
									container.addChild(inputBox_23, {
										"colIndex": 3,
										"rowIndex": 5
									});
									var inputBox_24 = new cpr.controls.InputBox("ipbFixFloat");
									inputBox_24.value = "0123.5600";
									container.addChild(inputBox_24, {
										"colIndex": 3,
										"rowIndex": 6
									});
									var inputBox_25 = new cpr.controls.InputBox("ipbTrim");
									inputBox_25.value = "     앞공백5 뒤공백3   ";
									...
									formLayout_8.setColumns(["1fr", "60px"]);
									formLayout_8.setRows(["1fr"]);
									group_16.setLayout(formLayout_8);
									(function(container){
										var inputBox_26 = new cpr.controls.InputBox("ipbSplitSlash");
										inputBox_26.value = "/";
										container.addChild(inputBox_26, {
											"colIndex": 1,
											"rowIndex": 0
										});
										var inputBox_27 = new cpr.controls.InputBox("ipbSplitNum");
										inputBox_27.value = "123/456/789";
									...
									var inputBox_28 = new cpr.controls.InputBox("ipbGetLength");
									inputBox_28.value = "자리수반환123";
									...
									inputBox_29.value = "getByteLength";
									...
									inputBox_30.value = "문자열 데이터의 Byte 길이(length)를 반환";
									container.addChild(inputBox_30, {
										"colIndex": 2,
										"rowIndex": 10
									});
									var button_10 = new cpr.controls.Button("btn8");
									button_10.value = "getByteLength";
									...
									var inputBox_31 = new cpr.controls.InputBox("ipbGetByte");
									inputBox_31.value = "자리수반환123";
