						...
						(function(container){
							...
							(function(container){
								...
								(function(container){
									...
									output_19.value = "모달리스(Modaless) 팝업을 호출";
									...
									output_24.value = "isPopup";
									output_24.style.setClasses(["content-form-opt"]);
									container.addChild(output_24, {
										"colIndex": 1,
										"rowIndex": 3
									});
									var output_25 = new cpr.controls.Output();
									output_25.value = "windowOpen";
									...
									output_27.value = "현재 화면이 팝업인지 여부 리턴";
									...
									output_29.value = "다이얼로그에서 [선택닫기] 시 부모창에 파라미터 전달";
