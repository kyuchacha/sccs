/*
 * App URI: app/exam/layout/pattern/templateTreeForm
 * Source Location: app/exam/layout/pattern/templateTreeForm.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/layout/pattern/templateTreeForm", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				...
				(function(container){
					...
					(function(tree_1){
						tree_1.setItemSet(app.lookup("dsDept"), {
							"label": "DNAME",
							"value": "DEPTNO",
							"parentValue": "UPDEPTNO"
						});
					})(tree_1);
				...
				(function(container){
					...
					var group_7 = linker.group_7 = new cpr.controls.Container("frfMain");
					group_7.fieldLabel = "사원정보";
					group_7.userAttr({
						"mobile-column-count": "2",
						"tablet-column-count": "2"
					});
					...
					formLayout_6.setRows(["25px", "25px", "25px", "25px", "25px", "25px", "25px", "25px", "25px", "1fr"]);
					...
					(function(container){
						...
						var inputBox_2 = linker.inputBox_2 = new cpr.controls.InputBox("ipb6");
						...
						var inputBox_3 = linker.inputBox_3 = new cpr.controls.InputBox("ipb11");
						...
						var inputBox_6 = new cpr.controls.InputBox("ipb18");
						...
						var inputBox_7 = new cpr.controls.InputBox("ipb19");
						...
						var numberEditor_3 = new cpr.controls.NumberEditor("nbe8");
						...
						var inputBox_8 = new cpr.controls.InputBox("ipb20");
			...
			// Linking
			linker.userDefinedControl_3.ctrl = linker.tree_1;
