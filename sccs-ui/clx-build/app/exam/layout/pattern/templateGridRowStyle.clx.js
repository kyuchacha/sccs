/*
 * App URI: app/exam/layout/pattern/templateGridRowStyle
 * Source Location: app/exam/layout/pattern/templateGridRowStyle.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/layout/pattern/templateGridRowStyle", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
							...
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										...
										numberEditor_1.bind("value").toExpression("COMM + 100");
				...
				grid_1.style.row.bind("background-color").toExpression([
					"switch(JOB){",
