/*
 * App URI: app/exam/layout/pattern/templateGridExpr
 * Source Location: app/exam/layout/pattern/templateGridExpr.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/layout/pattern/templateGridExpr", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
							...
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										...
										inputBox_4.bind("value").toExpression([
											"switch(DEPTNO){",
											"    when it == \"10\" : \"ACCOUNTING\"",
											"\twhen it == \"20\" : \"RESEARCH\"",
											"\twhen it == \"30\" : \"SALES\"",
											"\tdefault : \"OPERATIONS\"",
											"}"
				...
				grid_1.bind("readOnly").toExpression("DEPTNO == \"10\" ? true : false");
				grid_1.bind("enabled").toExpression("JOB == \"AAA05\" ? false : true ");
				grid_1.style.row.bind("color").toExpression([
					"switch(DEPTNO){",
					"\twhen it == \"10\" : \"#ff63a5\"",
					"\twhen it == \"20\" : \"#1676fb\"",
					"\twhen it == \"30\" : \"#816bff\"",
