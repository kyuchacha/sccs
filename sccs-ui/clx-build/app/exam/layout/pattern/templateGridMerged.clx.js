/*
 * App URI: app/exam/layout/pattern/templateGridMerged
 * Source Location: app/exam/layout/pattern/templateGridMerged.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/layout/pattern/templateGridMerged", {
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports){
			...
			(function(container){
				...
				grid_1.init({
					...
					"autoFit": "3, 5, 6, 7, 8, 9, 10, 4",
					"resizableColumns": "6, 7, 8, 9, 10, 4",
					"clickMode": "select",
						...
						"cells": [
							...
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										...
										inputBox_3.bind("value").toDataColumn("DEPTNO");
										return inputBox_3;
									})();
								}
							},
							{
								...
								"configurator": function(cell){
									...
									cell.control = (function(){
										...
										inputBox_4.bind("value").toDataColumn("ENAME");
										return inputBox_4;
									})();
								}
							},
							...
							},
							{
								...
								"configurator": function(cell){
									cell.columnName = "SAL";
									cell.suppressible = true;
									cell.mergeToIndexExpr = "COMM == 0 ? 10 : 9";
							...
							},
							{
								...
								"configurator": function(cell){
									cell.control = (function(){
										...
										numberEditor_3.bind("value").toExpression("SAL + COMM");
