/*
 * App URI: app/exam/mobile/mbCalendar
 * Source Location: app/exam/mobile/mbCalendar.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function(){
	var app = new cpr.core.App("app/exam/mobile/mbCalendar", {
			...
			(function(container){
				...
				(function(container){
					...
					(function(container){
						...
						output_2.value = "mobileCalendar.module.js";
					...
					output_3.value = "이 페이지에서는 모바일 캘린더에 적용할 수 있는 공통모듈에 대해 설명합니다.\r\n\r\n* mbUse = true 일 때 사용 가능\r\n* 데이트 인풋의 사용자 속성이 mobile-calendar = true 로 설정되고, 모바일 화면일 때 팝업형태로 제공";
				...
				(function(container){
					...
					output_5.value = "1. [모바일 캘린더 팝업 열기] 버튼을 클릭해 팝업창을 띄운다.\r\n2. 데이트 인풋을 클릭하여 모바일 캘린더 팝업을 확인한다.\r\n3. 스튜디오에서 사용자 속성 중 mobile-calendar = true를 확인한다.";
				...
				(function(container){
					...
					(function(container){
						...
						output_9.value = "모바일 버전";
						container.addChild(output_9, {
							"colIndex": 0,
							"rowIndex": 0
						});
						var button_1 = new cpr.controls.Button("btn1");
						button_1.value = "모바일 캘린더 팝업 열기";
