...
function onCombtnsearchSearch(/* cpr.events.CUIEvent */ e){
	// 1.데이터 변경사항 체크
	util.DataSet.isModifyForSearchBox(app, ["dsEmp"], function() {
		// 2.조회조건 유효성 체크
...
function onComButtonSave(/* cpr.events.CUIEvent */ e){
	...
	// 2. 유효성 체크
	if (!util.validate(app, "frfMain")) return false;
...
function onGrdMainBeforeSelectionChange(/* cpr.events.CSelectionEvent */ e){
	...
	return util.DataSet.isModifyForRowBeforeChangEvent(app, "grdMain", e, "dsEmp")
}
